$(document).ready(function() {
    ...
    $(".create-new .canvas").on("click", function() {
        ...
        var empty = false;
        $(".create-new").find("input[type='text'],input[type='number']").each(function() {
            if ($(this).val() === "") {
    ...
    // Delete canvas
    $(".container").on("click", ".draw-area .delete", function() {
    ...
    // Export HTML
    $(".container").on("click", ".draw-area .export-html", function() {
